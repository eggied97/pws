...
//	}
	...
	protected final Map<Integer, TypeMessage> messages_codes = this.createMapMessages();

	protected Map<Integer, TypeMessage> createMapMessages()
    {
		Map<Integer, TypeMessage> result= new HashMap<Integer, TypeMessage>() ;
		result.put(0, TypeMessage.TYPE_DISCONNECT);
		result.put(1, TypeMessage.TYPE_CONNECT);
		result.put(2, TypeMessage.TYPE_HEARTBEAT);
		result.put(3, TypeMessage.TYPE_MESSAGE);
		result.put(4, TypeMessage.TYPE_JSON_MESSAGE);
		result.put(5, TypeMessage.TYPE_EVENT);
		result.put(6, TypeMessage.TYPE_ACK);
		result.put(7, TypeMessage.TYPE_ERROR);
		result.put(8, TypeMessage.TYPE_NOOP);
...
{	
    ...
    {
		Map<Integer, TypeMessage> result= new HashMap<Integer, TypeMessage>() ;
		result.put(0, TypeMessage.TYPE_DISCONNECTED);
		result.put(1, TypeMessage.TYPE_CONNECTED);
		result.put(2, TypeMessage.TYPE_HEARTBEAT);
		result.put(3, TypeMessage.TYPE_PONG);
		result.put(4, TypeMessage.TYPE_MESSAGE);
		result.put(5, TypeMessage.TYPE_UPGRADE);
		result.put(6, TypeMessage.TYPE_NOOP);
		result.put(40, TypeMessage.TYPE_CONNECT);
		result.put(41, TypeMessage.TYPE_DISCONNECT);
		result.put(42, TypeMessage.TYPE_EVENT);
		result.put(43, TypeMessage.TYPE_ACK);
		result.put(44, TypeMessage.TYPE_ERROR);
		result.put(45, TypeMessage.TYPE_BINARY_EVENT);
		result.put(46, TypeMessage.TYPE_BINARY_ACK);
		//return Collections.unmodifiableMap(result);
		return result;
    }
    ...
    protected IOMessageV10x(String message)
	{
		...
		if(messages_codes.get(control) == TypeMessage.TYPE_MESSAGE)
		{
			control = 40;
